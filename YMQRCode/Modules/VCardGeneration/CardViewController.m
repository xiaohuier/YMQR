...
- (void)viewDidLoad {
    ...
    _cardTabelView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, WIDTH, HEIGHT) style:UITableViewStyleGrouped];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        ...
        case 3:{
            ...
            UILabel *detailRemarks = [[UILabel alloc]initWithFrame:CGRectMake(15, CGRectGetMaxY(labelRemarks.frame) - 5, WIDTH - 30, cell.frame.size.height)];
        ...
        case 4:{
            ...
            UILabel *detailRemarks = [[UILabel alloc]initWithFrame:CGRectMake(15, CGRectGetMaxY(labelRemarks.frame), WIDTH - 30, cell.frame.size.height)];
            detailRemarks.numberOfLines = 0;
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    _name = [[UILabel alloc]initWithFrame:CGRectMake(15, 19, WIDTH - 30, 25)];
    
    _companyName = [[UILabel alloc]initWithFrame:CGRectMake(15, CGRectGetMaxY(_name.frame) - 5, WIDTH - 30, 25)];
    
    _position = [[UILabel alloc]initWithFrame:CGRectMake(15, CGRectGetMaxY(_companyName.frame) - 5, WIDTH - 30, 25)];
